...
import sqlite3
sql = '''
SELECT co.tepon || ', ΑΦΜ:'|| tafm as epnym, tdrasi, co.taddr, tekpr ,
er.tonom || ' ' || er.tepon as onomatep, tpat, er.taddr,ttaft,'Αορίστου χρόνου' as ax,thmen,'' as liksi, tmeres,tores,torar,co.taddr,teid,tapod
FROM co
JOIN er
WHERE thmen=='19/1/2014'
'''
txt =u'''
...
<ol>
  ...
  <li>ΩΡΑΡΙΟ ΗΜΕΡΗΣΙΑΣ ΑΠΑΣΧΟΛΗΣΗΣ : {13}</li>
</ol>
