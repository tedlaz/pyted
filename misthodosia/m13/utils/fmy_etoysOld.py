...
def fmyEtoys(etos,rundate,db):
    ...
    for l in ed:
        fpa = d(l[16]/0.985)
        doc.addLine(3,['',l[1],'',l[2],l[3],l[4],l[5],l[6],l[7],l[8],l[9],l[10],l[11],l[12],l[13],l[14],l[15],fpa,l[17],l[18],'','',''])
        vl = {
               'Apo':u'1/1/%s' % etos,
               'Eos':u'31/12/%s' % etos,
               ...
               'ApodType':u'Μισθοί',
               'AkApod':u'%s'% gr0(l[10]),
               'Kratiseis':u'%s'% gr0(l[13]),
               'SynoloKrat':u'%s'% gr0(l[13]),
               'Katharo':u'%s' % gr0(l[14]),
               'Analogei':u'%s' % gr0(fpa),
               'Parakrat':u'%s' % gr0(l[16]),
               'Hmnia':u'%s' % rundate
               }
        vls.append(vl)
