...
def tst(hmnia, par, afm, ag13=0, ag24=0):
    """
    Υπάρχουν το πολύ 5 γραμμές
    1. Αγορές εμπορευμάτων 13%  100.00
    2. ΦΠΑ αγορών 13%            13.00
    3. Αγορές εμπορευμάτων 24%  100.00
    4. ΦΠΑ αγορών 24%            24.00
    5. 50.00.123123123                   237.00
    Για να μπορέσει να γίνει ανασύσταση της εγγραφής
    η συνάρτηση έχει έναν κωδικό
    """
    pass
