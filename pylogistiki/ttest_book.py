...
if __name__ == '__main__':
    ...
    eefile = '/home/tedlaz/pelates/2017/myf2017/ee2017d.txt'
    elfile = '/home/tedlaz/pelates/2017/myf2017/el2017d.txt'
    ...
    for i, lin in enumerate(book.eebook_myf(eefile)):
        # print(fst.format(**lin))
        if i == 0:
            print('|'.join([str(i) for i in lin.keys()]))
