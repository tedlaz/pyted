...
class Report_viewer(QtGui.QWidget):
    ...
    def __init__(self, html, pdf_name):
        ...
        self.buttonPrint = QtGui.QPushButton('odt', self)
        self.buttonPrint.clicked.connect(self.saveAsOdt)

        self.buttonPreview = QtGui.QPushButton('Print', self)
    ...
    def handlePreview(self):
        ...
        printer.setPageMargins(12, 12, 8, 8, 0)
        printer.setOutputFileName(self.pdf_name)
