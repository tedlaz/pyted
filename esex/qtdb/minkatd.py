...
sqla = '''
SELECT es.dat,sr.srp || es.par,pel.epon,et.etp,esd.val,esd.fpa,esd.val+esd.fpa as tot
from es
...
WHERE strftime('%Y',es.dat) = '2012' AND strftime('%m',es.dat) = '03'
ORDER BY es.dat,sr.srp,es.par
'''
sqles = '''
SELECT et.etp,
