...
class testprn1(QtGui.QDialog):
    def __init__(self):
        ...
        datafin = [[u'       ΈΣΟΔΑ',0,0,0,0,0,0],
                    [u'Πωλ.Πρ/ντ.Χονδρικές',955,181.45,4050,769.5,5005,950.95],
                    [u'Σύνολα εσόδων κεντρικού',955,181.45,4050,769.5,5005,950.95],
                    [u'Γενικό Σύνολο εσόδων',955,181.45,4050,769.5,5005,950.95],
                    [u'',0,0,0,0,0,0],
                    [u'       ΈΞΟΔΑ',0,0,0,0,0,0],
                    ...
                    [u'Γεν.Εξ.ΜΔΕΦ',1055.33,200.55,4170.93,785.71,5226.26,986.26],
                    [u'Ενοίκια',3470.4,0,500,0,3970.4,0],
                    [u'Σύνολο εξόδων κεντρικού',955,181.45,4050,769.5,5005,950.95],
                    [u'Γενικό σύνολα εξόδων',955,181.45,4050,769.5,5005,950.95],
                   ]
        f ={'orientation'  :0,
            'pdfName'      :'test.pdf',
            ...
            'ReportHeader3':u'',
            'headerLabels':[u'Τύπος',u'Από μεταφορά',u'ΦΠΑ',u'Περίοδος',u'ΦΠΑ',u'Σε μεταφορά',u'ΦΠΑ'],
