...
'''
from pyappgen.model import tables, fields, ddata, startSql
from pyappgen.model import fillTreeMenu, recFields, tblFlds, reprFlds

# Create your model here
# tables.add('tname', u'Περιγραφή πίνακα', u'Περιγραφή στον πληθυντικό',
#            'field1, field2,..', unique(fld1,fld2..))
...
tables.add('co', u'Στοιχεία Επιχείρησης',
           u'Στοιχεία Επιχείρησης', 'scop, scono')
...
ddata.add('co', [1, u'Κενό', u' ', u' ', u'0', u' ', u' ',
                 u' ', u' ', u' ', u' ', u' '])
