...
from dbmodel import tables, fields, ddata, startSql

bpath = os.path.dirname(os.path.abspath(__file__))

dbname = 'test.tst'

db = os.path.join(bpath,dbname)
...
tables.add('er',u'Εργαζόμενος',u'Εργαζόμενοι','sepo, sono', 'sepo, sono')
...
def create_demo_db():
    return dbu.dbScript(startSql(), db)
 
if __name__ == '__main__':
    print(startSql())
    #print(create_demo_db())