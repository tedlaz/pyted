    ...
    .controller('TodoController', [
        ...
        function($scope, $http, windowAlert) {
            ...
            $scope.addItem = function() {
                if (!$scope.state.newEpo) {
                    windowAlert("Το επώνυμο δεν μπορεί να είναι κενό!");
                } else if (!$scope.state.newOno){
                    windowAlert("Το όνομα δεν μπορεί να είναι κενό!");
                } else {
                    $http
                        .post('/todoAdd', {
                            epo: $scope.state.newEpo,
                            ono: $scope.state.newOno,
                            pat: $scope.state.newPat
                        })
