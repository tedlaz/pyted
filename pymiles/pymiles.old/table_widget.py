...
class Table_widget(QtGui.QTableWidget):
    ...
    def __init__(self, pin, parent=None):
        ...
        self.fields = pin.get('fields', None)
...
if __name__ == '__main__':
    ...
    labels = ['id', 'name']
    dlg1 = Table_widget({'rows': rows, 'labels': labels})
    dlg1.show()
    s = app.exec_()
    sys.exit(s)
