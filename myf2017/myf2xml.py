...
Προυποθέσεις:
Θα πρέπει να υπάρχει δημιουργημένο αρχείο sqlite με τα δεδομένα χρήσης (ac-elee2sqlite πρόγραμμα)
και να έχει γίνει μια βασική επεξεργασία για τις εγγραφές που περιλαμβάνονται και αποκλείονται.
