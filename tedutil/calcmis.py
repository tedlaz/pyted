...
3.Τύπος αποδοχών (μισθός/ημερομίσθιο/ωρομίσθιο)
4.Διάρκεια σύμβασης (ορισμένου χρόνου, αορίστου χρόνου, σύμβαση έργου)
5.Ημέρες εργασίας ανά βδομάδα
6.Ώρες εργασίας ανά βδομάδα
Όλες οι συμβάσεις είναι υποσύνολα της Γενικής Συλλογικής Σύμβασης Εργασίας, με
όρους προς το καλύτερο για τον εργαζόμενο.
Βασική σύμβαση εργασίας
1.Μισθωτών
  Ημέρες εργασίας ανά μήνα    : 25
  Ημέρες εργασίας ανά βδομάδα : 5 ή 6
  Ώρες εργασίας ανά βδομάδα   : 40
2.Ημερομισθίων
  Ημέρες εργασίας ανά μήνα    : 25 ή 26 ανάλογα
  Ημέρες εργασίας ανά βδομάδα : 5 ή 6
  Ώρες εργασίας ανά βδομάδα   : 40
  Ώρες εργασίας ανά ημέρα     : 40 / 5 ή 40 / 6
Για τον υπολογισμό του ΙΚΑ οι μέρες εργασίας ανάγονται σε 6 Χ (40 / 6)

Για τον υπολογισμό της εκ' περιτροπής ή μερικής απασχόλησης γίνονται αναλογικά
οι αντιστοιχίσεις.
